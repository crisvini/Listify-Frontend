...
const AnotacoesCardCompartilhado = ({ id, nome, anotacao, compartilhada, tags }) => {
    return (
        <div className="w-100 mt-2 bg-secondary-custom p-3 rounded-3">
            <div className="container-xxl p-0">
                <div className="row">
                    <div className="col-12">
                        <h5><Link to={'/anotacoes/' + id}>{nome} <i className="bi bi-arrow-return-right fs-7"></i></Link></h5>
                    </div>
                </div>
            </div>
            <div>
...
export default AnotacoesCardCompartilhado